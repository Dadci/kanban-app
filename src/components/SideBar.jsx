...
const SideBar = ({ open, setOpen }) => {
    ...
    return (
        <div className={`${open ? 'w-0 translate-x-[-260px] opacity-0' : 'w-[300px] translate-x-0 opacity-100'} 
            ...
            <div>
                ...
                {/* Analytics Button - Always at top */}
                <div 
                ...
                {/* Back to Boards - Only show on analytics page */}
                {isAnalyticsPage && (
                    <div 
                        onClick={() => navigate('/')} 
