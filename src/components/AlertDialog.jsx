    ...
    return (
        <div className='fixed inset-0 flex items-center justify-center  bg-neutral-950/70 z-50'>
            ...
            <div className='bg-white w-[500px] rounded-lg p-8 flex flex-col shadow-sm gap-6 '>
                <h1 className='text-destructive text-lg font-bold'>Delete this board?</h1>
                <p className='text-text-secondary text-sm leading-6'>Are you sure you want to delete the '{currentBoard?.name}' board? This action will remove all columns and tasks and cannot be reversed.</p>
